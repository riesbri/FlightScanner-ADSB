...
5. **Notifies** Discord in three tiers: 🚨 ALERT, 🛫 NOTEWORTHY, ✈️ ROUTINE
...
# Run
java -cp target/FlightScraper-0.0.1-SNAPSHOT-jar-with-dependencies.jar com.richi.ADSBFlightTracker
```
...
| **ROUTINE** | ✈️ | blue | Everything else (testing only) | ❌ |

**Rate limit:** NOTEWORTHY/ROUTINE pings are capped at 10/min by default.
...
| Business jet | 🛩️ | amber | GLEX, C56X, E55P, CL60 |
...
| `discord.rate.limit.per.minute` | `10` | Max NOTEWORTHY/ROUTINE pings per 60s |
